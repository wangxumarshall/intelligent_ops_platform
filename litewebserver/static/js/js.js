...
#205acf", "#c9c862", "#c98b62", "#c962b9", "#7562c9", "#c96262", "#c25775", "#00
b7be"],
                type: "pie",
                radius: [30, 70],
                center: ["35%", "50%"],
    ...
    function j() {
        ...
        option = {
            ...
            series: [{
                name: "",
                color: ["#62c98d", "#2f89cf", "#4cb9cf", "#53b666", "#62c98d", "
#205acf", "#c9c862", "#c98b62", "#c962b9", "#c96262"],
                type: "pie",
                startAngle: 0,
                radius: [51, 100],
                center: ["50%", "45%"],
    ...
    function k() {
        ...
        option = {
            ...
            xAxis: [{
                ...
                data: ["1月", "2月", "3月", "4月", "5月", "6月", "7月", "8月", "9月", "10
月", "11月", "12月"]
            }, {}],
            yAxis: [{
                axisLabel: {
            ...
            series: [{
                ...
                data: [220, 182, 191, 134, 150, 120, 110, 125, 145, 122, 165, 12
2]
            }, {
                name: "利润",
                type: "line",
                ...
                data: [120, 110, 125, 145, 122, 165, 122, 220, 182, 191, 134, 15
0]
            }]
        };
        a.setOption(option);
...
字段名称", "字段名称", "字段名称", "字段名称"],
            ...
            series: [{
                ...
                barWidth: "15",
                data: [100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 10
0],
                z: 5
            }],
        };
